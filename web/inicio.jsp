...
<body>
  ...
  <ul class="menuGrid">
    ...
    <a href="${pageContext.request.contextPath}/RegistroPropietario"><li><img src="${pageContext.request.contextPath}/web/img/lista.png""><p>Registrar Propietario</p></li></a>
    <a href="${pageContext.request.contextPath}/RegistroApartamento"><li><img src="${pageContext.request.contextPath}/web/img/lista.png""><p>Registro Apartamento</p></li></a>
